...
class LRFinder(object):
    ...
    def _train_batch(self, train_iter, accumulation_steps, non_blocking_transfer=True):
        ...
        for i in range(accumulation_steps):
            ...
            # Forward pass
            loss, log_dict = self.model.get_loss(batch_data)
    ...
    def _validate(self, val_iter, non_blocking_transfer=True):
        ...
        with torch.no_grad():
            for batch_data in val_iter:
                ...
                loss, log_dict = self.model.get_loss(batch_data)
                running_loss += loss.item() * batch_data[0].shape[0]
...
class LinearLR(_LRScheduler):
    ...
    def get_lr(self):
        ...
        return [base_lr + r * (self.end_lr - base_lr) for base_lr in zip(self.base_lrs, self.base_lrs)]
