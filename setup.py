...
# since we save this data in transformers/dependency_versions_table.py it can be easily accessed from
...
class DepsTableUpdateCommand(Command):
    ...
    user_options = [
        ...
        ("dep-table-update", None, "updates transformers/dependency_versions_table.py"),
    ]
    ...
    def run(self):
        ...
        target = "transformers/dependency_versions_table.py"
